...
/**
* @brief          Symbolic name for the channel DioChannel_led_PTD15.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_DioChannel_led_PTD15 ((uint16)0x006fU)

/**
* @brief          Symbolic name for the channel DioChannel_led_PTD16.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_DioChannel_led_PTD16 ((uint16)0x0070U)
